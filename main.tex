...
Middle deflations are improbable because they rely on the spikes having many
zeros, and the spike values depend on shift choices. Deflations can be induced
with proper shift choices. Specifically, the proper shifts can be found by
solving:
%
\begin{align}
...
used to deflate matrices through optimal shift choices.
