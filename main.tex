...
\end{align*}
%
\newline\noindent{}\textbf{A \emph{bulge} is chased down the diagonal}. To speed convergence
...
\end{align*}
%
\newline\noindent{}We can then create $Q$ by embedding $Q_\text{sub}$ into the identity. Applying
...
\end{align*}
%
\newline\noindent{}This matrix is then reduced to Hessenberg form again. If half of the values on
...
\end{align*}
%
\newline\noindent{}Many effective methods for minimizing functions rely upon derivative information
