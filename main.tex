...
\end{align*}
%
A \emph{bulge} is repeatedly \textbf{chased down diagonally}. To speed
...
started from the bottom, and the two can meet in the imddle right.  A
...
\\[1ex]
%
\vimage{ \begin{tikzonimage}[width=0.096\linewidth]{plots3/impstep002.eps} \end{tikzonimage} }
\!\!\vpointer\!\!
\vimage{ \begin{tikzonimage}[width=0.096\linewidth]{plots3/impstep004.eps} \end{tikzonimage} }
\!\!\vpointer\!\!
\vimage{ \begin{tikzonimage}[width=0.096\linewidth]{plots3/impstep005.eps} \end{tikzonimage} }
&
\!\!\vpointer\!\!
...
\\[1ex]
%
\vimage{ \begin{tikzonimage}[width=0.064\linewidth]{plots4/impstep001.eps} \end{tikzonimage} }
\!\!\vpointer\!\!
\vimage{ \begin{tikzonimage}[width=0.064\linewidth]{plots4/impstep002.eps} \end{tikzonimage} }
\!\!\vpointer\!\!
\vimage{ \begin{tikzonimage}[width=0.064\linewidth]{plots4/impstep003.eps} \end{tikzonimage} }
&
\!\!\vpointer\!\!
...
\node [shift={(-30.5in,-13.5in)}, align=center, anchor=center] at (current page.north east) {
	\Large            \textbf{Recursion is a} \\[1.5ex]
...
$\mathbf{A}$ into $\mathbf{T}$}. Consider a submatrix $A_\text{sub}$ and compute
$Q_\text{sub}$:
%
\begin{align*}
...
neighborhood of the decomposition, the subdiagonal of $A$ is zeroed and the
spikes form.
%
\begin{align*}
...
%----------------------------------------------------------------------------------------
\begin{block}{Automatic Differentiation (AD)}
%
\begin{align*}
	M_{n+1} = \mathtt{MiddleDeflation}(M, \mathtt{shifts})
\end{align*}
%
AD tools can be applied to compute the sensitivities of the spike tips to the
shifts.
%
\begin{align*}
	\frac{d M_{n+1}}{d\mathtt{shifts}} = \mathtt{func}(M, \mathtt{shifts})
\end{align*}
...
The authors are pursuing publication.
