...
opposed to existing algorithms. Furthermore, it does so by exploiting AD
methods which are highly parallelizable. We are currently prototyping this
algorithm in \href{http://octave.org/}{GNU Octave}.
